...
async def project_page(parent):
    ...
    mojo_csv_container = Div(
        projects_container,
        "mojo_csv-project-container",
        class_list={"project-container"},
    )
    Label(mojo_csv_container, "mojo_csv-label", inner_text="mojo_csv")
    Img(
        mojo_csv_container,
        "mojo_csv-img",
        src="/assets/imgs/mojo_csv_logo.png",
        class_list={"project-img"},
    )
    A(
        mojo_csv_container,
        "mojo_csv-gh-link",
        href="https://github.com/Phelsong/mojo_csv",
        class_list={"link-icon"},
